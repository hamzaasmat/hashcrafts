...
import DetailsBody from "../components/hashcraft/solutions/ecommerce/DetailsBody";
import Feature from "../components/hashcraft/solutions/ecommerce/Feature";
...
export default () => (
  <Preloader>
    ...
    <Header />
    <PageTitle title="E-commerce Solution" />
    <DetailsBody />
    <Feature />
    <CtaArea />
    <Footer />
