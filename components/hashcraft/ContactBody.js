...
export default class ContactBody extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <section className="contact-info-area ptb-80 bg-f7fafd">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="contact-info-box">
                  ...
                  <h3>Visit Here</h3>
                  <p>
                    IT Tower Gulberg, Lahore, 54000, <br /> Pakistan
                  </p>
                </div>
              </div>
        ...
        <section className="contact-area ptb-80" id="quotes">
          <div className="container">
            ...
            <div className="row h-100 justify-content-center align-items-center">
              <div className="col-lg-6 col-md-12">
                <img
                  src={require("../../static/images/home/contact.png")}
                  alt="image"
                />
              </div>
